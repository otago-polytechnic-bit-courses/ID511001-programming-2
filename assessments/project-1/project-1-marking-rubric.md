...
| **Player Controls for Paddle**                        | Player controls left paddle with up and down arrow keys. | Minor issues in player controls.                    | Significant issues in player controls.             | Player controls are not implemented correctly.         |
