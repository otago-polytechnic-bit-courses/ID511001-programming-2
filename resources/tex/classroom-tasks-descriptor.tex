...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Explain the concept of prefabs. What are they, \& how do they contribute to the efficiency \& reusability?
        \item In the game Pong, how would you implement the collision detection between the ball \& the paddles using colliders?
    \end{itemize}
\end{itemize}
