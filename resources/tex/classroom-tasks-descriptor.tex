...
\lfoot{Classroom Tasks : Learner Gradebook\\Version 1, Semester One, 2023}
\rfoot{\thepage}
...
\subsection*{Questions - Learning Outcomes 1 \& 2 (15\%)}
\begin{itemize}
    \item Provide answers to the following questions in your repository \textbf{README.md} file:
    \begin{itemize}
        \item 
    \end{itemize}
\end{itemize}
