...
\title{Course Directive\\ID511001: Programming 2\\Semester One, 2026}
\date{}
\maketitle
...
\begin{tabular}{ll}
	...
	Timetable:    & Tuesday 1.00 PM D207 and Thursday 1.00 PM D207  \\
\end{tabular}

\section*{Teaching Staff}
\begin{tabular}{lll}
	Name:            & Rachel Trounson \\
	Position:        & Senior Lecturer \\
	Office Location: & D316a                                 \\
	Email Address    & rachel.trounson@op.ac.nz \\                    
\end{tabular}

\section*{Course Dates}
\begin{tabular}{ll}
	Term 1 (7 weeks):            & 23 February - 10 April          \\ 
	Mid-Semester Break:           & 11 April - 27 April        \\
	Term 2 (9 weeks):             & 28 April - 03 July       \\
\end{tabular}
...
\begin{tabular}{|c|c|c|c|}
	...
	\small Project 1 & \small 35\%        & \small TBC at 11.59 PM  & \small 1, 2                  \\ \hline
	\small Project 2  & \small 35\%        & \small TBC at 11.59 PM   & \small 1, 2                  \\ \hline
	\small Skills-Based Assessment                        & \small 30\%        & \small TBC from 10.00 AM - 11.45 AM & \small 1, 2                  \\ \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|}
	...
	1/Tahi            & \multicolumn{2}{c|}{GitHub and C\#}    \\ \hline
	2/Rua             & \multicolumn{2}{c|}{Arrays, Lists, Dictionaries and LINQ}                   \\ \hline
	3/Toru            & \multicolumn{2}{c|}{Windows Forms Application} \\ \hline
	4/Whā             & \multicolumn{2}{c|}{Classes, Objects and Encapsulation}                               \\ \hline
	5/Rima            & \multicolumn{2}{c|}{Abstraction, Inheritance and Polymorphism}                                                \\ \hline
	6/Ono              & \multicolumn{2}{c|}{Interfaces and Enumerations}                                                   \\ \hline
	...
	11/Tekau mā tahi & \multicolumn{2}{c|}{Skills-Based Assessment}                                                                 \\ \hline
	...
	16/Tekau mā ono   & \multicolumn{2}{c|}{Assessment Marking Week}                                                         \\ \hline
\end{tabular}
...
In case of sickness contact the teaching staff or \textbf{Head of School (Michael Holtz)} as soon as possible, preferably before the assessment is due. The policy regarding the granting of a mark that considers impaired performance requires a medical certificate and a medical practitioner’s signature on a form. You may refer to the guide on impaired performance on the student handbook.

\subsection*{Appeals}
If you are concerned about any aspect of your assessment, approach the teaching staff in the first instance. We support an open-door policy and aim to resolve issues promptly. Further support is available from the \textbf{Head of School (Michael Holtz)}. \textbf{Otago Polytechnic} has a formal process for academic appeals if necessary.
