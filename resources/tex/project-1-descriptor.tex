...
In this \textbf{individual} assessment, you will design and develop a pong \textbf{Windows Forms Application} using \textbf{C\#}.
...
\begin{itemize}
    \item An exemplar is available in \textbf{assessment $>$ project 1} directory of the \textbf{course materials} repository.
