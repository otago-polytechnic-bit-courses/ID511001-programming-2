...
\begin{itemize}
    ...
    \item The player one controls the left paddle via the \textbf{A} and \textbf{D} keys. The player two controls the right paddle via the \textbf{left arrow} and \textbf{right arrow} keys.
