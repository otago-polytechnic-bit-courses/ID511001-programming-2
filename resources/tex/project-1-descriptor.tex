...
\begin{itemize}
    ...
    \item The player one controls the left paddle via the \textbf{W} and \textbf{S} keys. The player two controls the right paddle via the \textbf{left arrow} and \textbf{right arrow} keys.
