...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{lastName}
        \item \textbf{AssessmentMarks} object called \textbf{prog1AssessmentMarks}
        \item \textbf{AssessmentMarks} object called \textbf{prog2AssessmentMarks}
    \end{itemize}
    ...
    \end{itemize}
    \item An \textbf{AssessmentMarks} object has several behaviours such as getting all marks, all grades, highest mark(s), lowest mark(s), fail mark(s), average marks and average grades.
    ...
    \begin{itemize}
        ...
        \item 0. Exit
    \end{itemize}
    \textbf{Note:} You will need to create individual methods to achieve this functionality. Also, the app \textbf{must} be able to handle invalid user input. If the user enters an invalid option, an error message \textbf{must} be displayed.
    \begin{figure}[ht]
        \centering
...
\begin{itemize}
    \item Adhere to the two principles of \textbf{OO}, i.e., encapsulation \& abstraction.
...
\begin{itemize}
    ...
    \item Commit messages \textbf{must} be formatted using the recommended conventions \& reflect the context of each functional requirement change.
\end{itemize}
