...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{DisplayDetails()} which is an \textbf{public abstract} method, has no arguments \& returns a \textbf{string}
        \end{itemize}    
    ...
    \begin{itemize}
        ...
        \item \textbf{GetAverageMarks()} which has no arguments \& returns a \textbf{double}
    ...
    \item 10 \textbf{unit tests} using \textbf{MSTest} which verify the functionality.
\end{itemize}
