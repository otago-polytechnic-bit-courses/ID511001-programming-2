...
You will complete this assessment during your learner-managed time. However, there will be time during class to discuss the requirements \& your progress on this assessment. This assessment will need to be completed by \textbf{Monday, 17 October 2022} at \textbf{4.59 PM}.
...
\begin{itemize}
    ...
    \item A ball \& two paddles \textbf{must} be created using the \textbf{Graphics} class. A \textbf{Panel} control  for a paddle will  also be accepted.
    ...
    \begin{itemize}
        \item A highscore system. When the game is over, the user \& computer's scores are saved, i.e., written to a text file. Read the scores from the text file and display the last five to the user.
