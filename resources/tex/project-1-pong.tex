...
\lfoot{Project 1: Pong\\Version 1, Semester Two, 2022}
\rfoot{\thepage}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item A highscore system. When the game is over, the user \& computer's scores are saved, i.e., written to a text file. Display the last five scores to the user.
