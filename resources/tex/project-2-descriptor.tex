...
\begin{itemize}
	\item Project Structure and Organisation (10\%)
	\begin{itemize}
		\item 
	\end{itemize}
	\item Naming Conventions (5\%)
	\item Code Practices and Readability (10\%)
	\item Documentation and Comments (5\%)
	\item Code Formatting (5\%)
	\item Dead Code and Unused Dependencies (5\%)
	\item Performance and Scalability (5\%)
\end{itemize}
