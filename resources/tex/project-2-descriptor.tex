...
\lfoot{Project 2\\Version 5, Semester One, 2025}
\rfoot{\thepage}
...
\begin{tabular}{|c|c|c|c|}
	...
	\small Project 1 & \small 25\%        & \small Wednesday 11th June at 4:59 PM  & \small 1, 2                  \\ \hline
	\small Project 2  & \small 35\%        & \small Sunday 4th May at 4:59 PM   & \small 1, 2                  \\ \hline
	\small Theory Examination                        & \small 30\%        & \small Monday 19th May from 3:00 PM - 4:45 PM & \small 1, 2                  \\ \hline
	\small Classroom Tasks                      & \small 10\%        & \small Sunday 4th May at 4:59 PM  & \small 1, 2                  \\ \hline
\end{tabular}


\section*{Conditions of Assessment}
You will complete this assessment mostly during your learner-managed time. However, there will be time during class to discuss the requirements and your progress on this assessment. This assessment will need to be completed by  \textbf{Sunday 4th May} at \textbf{4.59 PM}.
...
\subsubsection*{Student Management System - 45\%}

Create a new \textbf{Windows Forms Application} called \textbf{StudentManagementSystem}.The application needs to open without code or file structure modification in \textbf{Visual Studio}.

\subsubsection*{Part 1 (10\%) - Due Sunday 23rd March at 4.59 PM}
...
\subsubsection*{Part 2 (10\%) - Due Sunday 30th March at 4.59 PM}
...
\subsubsection*{Part 3 (10\%) - Due Sunday 6th April at 4.59 PM}
...
\subsubsection*{Part 4 (15\%) - Due Sunday 13th April at 4.59 PM}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/display-course-details.PNG}
        \end{figure} 
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/display-all-marks.PNG}
        \end{figure} 
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/display-all-grades.PNG}
        \end{figure} 
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/display-highest-marks.PNG}
        \end{figure} 
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/display-lowest-marks.PNG}
        \end{figure} 
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/display-fail-marks.PNG}
        \end{figure} 
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/display-average-marks.PNG}
        \end{figure} 
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/display-average-grades.PNG}
        \end{figure} 
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/display-lecturer-details.PNG}
        \end{figure} 
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/add-a-learner.PNG}
        \end{figure} 
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=100mm]{../../resources/img/project-2/add-a-lecturer.PNG}
        \end{figure} 
...
\subsubsection*{Attendance Tracker - 10\%}

Create a new \textbf{Windows Forms Application} called \textbf{AttendanceTracker}. The application needs to open without code or file structure modification in \textbf{Visual Studio}.

\subsubsection*{Part 5 (10\%) - Due Sunday 4th May at 4.59 PM}

\begin{itemize}
    \item Add a \textbf{Reference} to the \textbf{Student Management System} application.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=100mm]{../../resources/img/project-2/attendance-tracker-example.png}
\end{figure} 
